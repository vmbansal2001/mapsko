...
const properties = [
  {
    ...
    description:
      "Mapsko MountVille is an artistic representation customized for those who apprehend the merit of luxury and abundance of greenery. Nestled in sector-79, Gurugram, offering 3-4 BHK luxury apartments in Gurugram is a pure model of urban architecture, which is designed to perfection. Aravali is a quintessential complement to this wonderful project, which has been marvelously arranged by the World's leading landscape architects- LSG Inc, USA and structured by Shapoorji Pallonji.",
    linkHref: "/",
  },
  {
    ...
    address: "Sector 82, Sector Road, NH-8, Gurugram",
    description:
      "Enjoy a heavenly experience living at MapskoCasabella. This residential project in Gurugram by Mapsko is surrounded by beautiful garden and parks; the place is one of the most luxurious residences in the city. It has beautiful interiors infused with the modern comforts, furnished with finest settings, especially designed by highly experienced architects that will make you look twice. The apartment has a perfect blend of natural beauty and lavish amenities where the family bond and relations get much deepened like never before.",
    linkHref: "/",
  },
  {
  ...
  },
  {
    ...
    address: "Sector-82 Gurugram",
    description:
      "Mapsko presents an all-in-one commercial project in Gurugram that offers multiple shopping outlets, food court, entertainment, and other essential merchandises that suit the needs of every individual. This shopping complex offers numerous lavish facilities to the customers and caters to their demands so that an individual loves to come here again and again.",
    linkHref: "/",
  },
];
